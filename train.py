...
#Prepare input data
classes = ['canaletto','claude_monet','george_romney','jmw_turner','john_robert_cozens','paul_cezanne','paul_gauguin','paul_sandby','peter_paul_rubens','rembrandt','richard_wilson']
